...
**YOU ARE IN: `shadowdark_sheet/polecats/dementus/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/shadowdark_sheet/` (rig root) or other directories
...
**Your mail address:** `shadowdark_sheet/polecats/dementus`
**Your rig:** shadowdark_sheet
**Your Witness:** `shadowdark_sheet/witness`
...
| Ask Witness for help | `gt mail send shadowdark_sheet/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`shadowdark_sheet/witness`) when:
...
```bash
gt mail send shadowdark_sheet/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
